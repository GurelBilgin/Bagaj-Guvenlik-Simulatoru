...
class BaggageSecuritySimulator:
    ...
    def rapor_kaydet(self, reports_dir: str | Path = "reports") -> Path:
        """Gün sonu raporunu tek TXT dosyası olarak kaydeder.

        Her rapor tarih-saat bilgisi içeren benzersiz bir dosya adıyla saklanır.
        Eski sürümde ayrıca son_gun_sonu_raporu.txt oluşturuluyordu.
        Bu kopya kaldırıldı; artık yalnızca tek rapor dosyası oluşturulur.
        """
