...
7. İstenirse `TXT Rapor Kaydet` butonu ile rapor dosyası oluşturulabilir.
...
```text
v1.0.1 - Rapor Klasörü Düzeltmesi
```

Bu sürümde EXE üzerinden çalıştırıldığında TXT raporların kaydedildiği klasör düzenlenmiştir. Raporlar artık EXE dosyasının bulunduğu dizindeki `reports/` klasörüne kaydedilir.
